 ...
 * Version: 0.7.0 - 2014-10-06T02:54:01.404Z
 * License: MIT
 */
...
$templateCache.put("bootstrap/match-multiple.tpl.html","<span class=\"ui-select-match\" ui-sortable=\"\"><span ng-repeat=\"$item in $select.selected\"><a style=\"margin-right: 3px;\" class=\"ui-select-match-item btn btn-default btn-xs btn-flat\" tabindex=\"-1\" type=\"button\" ng-disabled=\"$select.disabled\" ng-click=\"$select.activeMatchIndex = $index;\" ng-class=\"{\'btn-primary\':$select.activeMatchIndex === $index}\"><span class=\"close ui-select-match-close\" ng-hide=\"$select.disabled\" ng-click=\"$select.removeChoice($index)\">&nbsp;&times;</span> <span uis-transclude-append=\"\"></span></a></span></span>");
